  ...
  try {
    ...
    productos.forEach(prod => {
      ...
      card.innerHTML = `
        ...
        <button class="add-to-cart" data-product="${escapeHtml(prod.nombre)}" data-price="${prod.precio}">Agregar al Carrito</button>
      `;
      contenedor.appendChild(card);
    });

    asignarEventosCarrito(); // reasignar listeners
  } catch (e) {
